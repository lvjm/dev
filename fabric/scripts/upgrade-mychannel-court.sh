...
#peer chaincode instantiate -n $CC_NAME --tls true --cafile ${ORDERER_CA} -c '{"Args":["init"]}' -v $CC_VERSION -C $CHANNEL_NAME -P "OutOf(1, 'Org1MSP.member','Org2MSP.member','Org3MSP.member')"
